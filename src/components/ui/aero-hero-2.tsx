        ...
        <div className="flex items-center justify-between text-left">
          ...
          <div className="mt-auto space-y-7">
            ...
            <div className="flex w-fit gap-6">
              <Button className="group mx-auto flex cursor-pointer items-center justify-center gap-0 rounded-full border-none bg-transparent px-0 py-5 font-normal shadow-none hover:bg-transparent">
